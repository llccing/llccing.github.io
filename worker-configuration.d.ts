/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: c6d5cdf1b552bafdd16e4e55945ac47f)
...
interface __BaseEnv_Env {
	...
	ALLOWED_ORIGINS: "https://rowanliu.com,https://phase-1.rowan-blog.pages.dev,https://codex-cloudflare-pages-phase.rowan-blog.pages.dev,https://a5e22028.rowan-blog.pages.dev,http://localhost:4321,http://127.0.0.1:4321";
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./workers/comments-api/src/index");
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GITHUB_OWNER" | "GITHUB_REPO" | "GITHUB_REPO_ID" | "GITHUB_CATEGORY_ID" | "OWNER_LOGIN" | "SITE_URL" | "ALLOWED_ORIGINS">> {}
}
