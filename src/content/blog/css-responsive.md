---
pubDatetime: 2018-10-01T00:00:00Z
title: "响应式 Web 设计"
slug: css-responsive
featured: false
draft: false
tags:
  - css
description: "主要是应用在官网的设计， CSS3媒体查询可以让我们针对不同的媒体类型定义不同的样式，当浏览器窗口变化的过程中，页面会根据浏览器的宽度和高度重新渲染页面。 定义浏览器的分隔点，可以参考bootstrap或者其他更细致的方案。"
---
