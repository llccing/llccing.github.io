---
pubDatetime: 2019-09-01T00:00:00Z
title: "Virtual DOM 详解"
slug: vue-analysis-virtual-dom
featured: false
draft: false
tags:
  - vue
description: "直接操作DOM会影响性能，所以才产生了虚拟DOM。 一个对象，两个前提，三个步骤。 Virtual DOM是一个基本的JavaScript对象，也是整个Virtual DOM数的基本。"
---
