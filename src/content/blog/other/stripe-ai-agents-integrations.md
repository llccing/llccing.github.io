...
_AI 编码智能体在 Stripe 集成基准测试上的性能对比_
...
_Michelle Bu 是 Stripe 的 CTO。关注 Stripe 的 [Twitter](https://twitter.com/stripe) 获取更多关于 AI 和开发者工具的更新。_
