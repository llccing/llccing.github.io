...
sourceUrl: "https://riegler.fr/blog/2025-02-16-incremental-dom/"
---
...
Once this feature is enabled, let's build a basic example with a static DIV and a dynamic one.
...
2. one with an interpolation that is computed during the update mode
