...
sourceUrl: "https://riegler.fr/blog/2023-09-20-cd-coalescing"
---

![Image](/blog-images/cd-coalescing/larry-costales-YFR_x3MqpHc-unsplash.jpg)

In Angular, when it comes to zone-based change detection, we sometimes need to trigger it by hand. At the time of writing this article there is no API to schedule a new ChangeDetection (CD) cycle ([pending issue](https://github.com/angular/angular/issues/43168)).

## Foreword

This article will be talking about JS internals and more particularly about the browser's event loop.

If you're not familiar with terms like _microtask_, _macrotask_ or _queues_, I recommend you read this great article by Jake Archibald: [Tasks, microtasks, queues and schedules](https://jakearchibald.com/2015/tasks-microtasks-queues-and-schedules/).
...
![Not great, not terrible](/blog-images/cd-coalescing/not-great.jpg)
