...
sourceUrl: "https://riegler.fr/blog/2023-11-03-performance-for-repeaters"
---
...
| - Was the default in ngFor `trackBy` - Good option only if you don't use immutability | - When in doubt, its a good default - Will mess things up if items are sorted/moved/replaced | - The most flexible/reliable one - requires a unique identifier per item |
