---
pubDatetime: 2017-06-01T00:00:00Z
title: "前端基础设施 (Gulp)"
slug: gulp-frontend-infra
featured: false
draft: false
tags:
  - tooling
description: "* 自动清除缓存，自动刷新，加速开发调试过程 [browserSync](https://www.browsersync.io/) or [browserSync国内](http://www.browsersync.cn/)"
---
      ...
      amdOptimize(baseDir + "/js/index", {
        paths: {
          ...
          "bootstrap-table-zh-CN":
            "static/bootstrap-table/bootstrap-table-zh-CN.min",
          "bootstrap-table-export":
            "static/bootstrap-table/bootstrap-table-export",
          tableExport: "static/bootstrap-table/tableExport",
          "bootstrap-datetimepicker":
            "static/bootstrap-datetimepicker/js/bootstrap-datetimepicker.min",
          "bootstrap-datetimepicker-zh-CN":
            "static/bootstrap-datetimepicker/js/bootstrap-datetimepicker.zh-CN",
...
gulp.task("revcss", function () {
  return (
    gulp
      .src([distDir + "/css/*.json", distDir + "/*.html"])
...
![file-structure](/blog-images/fileStructure.png)
