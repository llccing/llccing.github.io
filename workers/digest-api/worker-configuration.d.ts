/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=workers/digest-api/wrangler.jsonc workers/digest-api/worker-configuration.d.ts` (hash: 0b1dc29783967a366df8731392cf4c50)
// Runtime types generated with workerd@1.20260801.1 2026-08-19 nodejs_compat
interface __BaseEnv_Env {
	DIGEST_PRIMARY_MODEL: "grok-4.6";
	DIGEST_FALLBACK_MODEL: "gpt-5.6-sol";
	DIGEST_WORKFLOW: Workflow<Parameters<import("./src/index").DigestWorkflow['run']>[0]['payload']>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DIGEST_PRIMARY_MODEL" | "DIGEST_FALLBACK_MODEL">> {}
}
